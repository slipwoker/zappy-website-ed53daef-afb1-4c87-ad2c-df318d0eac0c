document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            const nameInput = contactForm.querySelector('[name="name"], #name, input[type="text"]:not([name="email"]):not([name="phone"]):not([type="email"]):not([type="tel"])');
            const emailInput = contactForm.querySelector('[name="email"], #email, input[type="email"]');
            const phoneInput = contactForm.querySelector('[name="phone"], #phone, input[type="tel"]');
            const messageInput = contactForm.querySelector('[name="message"], #message, textarea');
            ...
            if (isValid) {
                ...
                if (submitButton) {
                    ...
                    setTimeout(function() {
                        ...
                        successMessage.style.cssText = 'color: #38a169; font-size: 0.875rem; margin-top: 1rem; text-align: center;';
    ...
    const animatedElements = document.querySelectorAll('.fade-in, .animate, [data-animate], .reveal');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'ed53daef-afb1-4c87-ad2c-df318d0eac0c',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'ed53daef-afb1-4c87-ad2c-df318d0eac0c';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'ed53daef-afb1-4c87-ad2c-df318d0eac0c';
